# prompt.md — package-split phase runner
...
| id | title | file |
|---|---|---|
| phase01 | infra-package | `docs/package-split/phase01_infra-package.md` |
| phase02 | forecasting-package | `docs/package-split/phase02_forecasting-package.md` |
| phase03 | app-boundaries | `docs/package-split/phase03_app-boundaries.md` |
| phase04 | tooling-docs | `docs/package-split/phase04_tooling-docs.md` |
