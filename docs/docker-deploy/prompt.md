# prompt.md — docker-deploy phase runner
...
| id | title | file |
|---|---|---|
| phase01 | config-file-override | `docs/docker-deploy/phase01_config-file-override.md` |
| phase02 | inference-entrypoint-and-stub | `docs/docker-deploy/phase02_inference-entrypoint-and-stub.md` |
| phase03 | env-secrets-provider | `docs/docker-deploy/phase03_env-secrets-provider.md` |
| phase04 | images | `docs/docker-deploy/phase04_images.md` |
| phase05 | compose-and-smoke | `docs/docker-deploy/phase05_compose-and-smoke.md` |
| phase06 | docs | `docs/docker-deploy/phase06_docs.md` |
