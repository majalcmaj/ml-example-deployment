# prompt.md — notebook-regression phase runner
...
| id | title | file |
|---|---|---|
| phase01 | baseline-and-training-regression | `docs/notebook-regression/phase01_baseline-and-training-regression.md` |
| phase02 | inference-output-and-regression | `docs/notebook-regression/phase02_inference-output-and-regression.md` |
| phase03 | wire-and-document | `docs/notebook-regression/phase03_wire-and-document.md` |
